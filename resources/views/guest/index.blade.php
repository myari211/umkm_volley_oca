        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg bg-white navbar-light p-lg-0">
                <a href="index.html" class="navbar-brand d-lg-none">
                    <h1 class="fw-bold m-0">Volley Gunadarma</h1>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav pt-2 pb-2">
                        <a href="/">
                            <img src="{{ asset('img/properties/gunadarma.png') }}" style="width: 80px;">
                        </a>
                        <a href="index.html" class="nav-item nav-link active" style="margin-left: 30px;">Home</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('img/properties/history.jpg') }}" alt="Image" style=" -webkit-mask-image: linear-gradient(black, black); mask-image: linear-gradient(black, black);">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7 text-start">
                                    <p class="fs-4 text-white animated slideInRight">Welcome to
                                        <strong>Gunadarma University Volleball</strong>
                                    </p>
                                    <h1 class="display-1 text-white mb-4 animated slideInRight">Save Your Health With Your Abilty</h1>
                                    <a href="/register"
                                        class="btn btn-primary rounded-pill py-3 px-5 animated slideInRight">Join Us</a>
                                </div>
                            </div>
                        </div>
                    </div>
